                  ...
                  tabsetPanel(
                    ...
                    tabPanel("Search",
                             ...
                             column(width = 6,
                                    ...
                                    textInput("candidates", label = "Player name", 
                                              width = 250, value = "Ronaldo"),
                    ...
                    tabPanel("Table",
                             ...
                             # DT sütun renk ayarı
                             tags$head(tags$style("#table_similarity thead th{background-color: #f5971d; color: #231f20;}")),
                    ...
                    tabPanel("Comparison",
                             ...
                             conditionalPanel(
                               ...
                               selectInput("comp_select", label = "Select Player", 
